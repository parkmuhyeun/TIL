...
public class TokenService {
    ...
    public final static long accessTokenValidTime = 30 * 60 + (60 * 60 * 9);// 토큰 유효시간 30분(UTC +9)
    public final static long refreshTokenValidTime = (30 * 60) * 48 * 7 + (60 * 60 * 9); //일주일(UTC +9)
