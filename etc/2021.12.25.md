...
- post 목차 설정
    - 목차를 구성하는 HTML 파일준비(title-table-of-contents.html)
```html
<span class="table-of-contents-list">Spring 강좌는 여러 절로 구성되어 있습니다. </span>
<ul class="table-of-contents-list">
    <li><a href="./Spring-basic">Spring 첫 페이지</a></li>
    <li><a href="./python-second">Spring 두 번째 페이지</a></li>
</ul>
```

- css style -> Gulp를 통해 minified -> node 설치, gulpfile.js 수정, package.json 수정 -> npm install -> gulp css
