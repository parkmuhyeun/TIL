...
- gem 설치
- Webstorm 설치
- yaml수정(블로그 생성에 대한 전체 환경 세팅을 담당하는 파일)
```yaml
...
url: https://parkmuhyeun.github.io
...
production_url: https://parkmuhyeun.github.io
# 최종적으로 blog가 운영될 url

source_url: https://github.com/parkmuhyeun/GitHubPageMaker/
...
기본적으로 Jekyll build는 development 세팅, 실제 GitHub Page에 Publishing할 목적으로 build하는 것이라면 JEKYLL_ENV 환경변수의 값을 production으로 설정한 후 build를 진행