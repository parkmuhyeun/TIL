...
# print(python.find("Java")) # 없는 경우 -1
# print(python.index("Java")) # 없는 경우 오류냄
...
# site = "http://naver.com"
# asite = site.replace("http://", "")
# dotindex = asite.index(".")
# aasite = asite[:dotindex]
# password = aasite[:3] + str(len(aasite)) + str(aasite.count("e")) + "!"
# print(password)
...
# print(cabinet.get(3))
# print(cabinet[5]) # [] 경우 없으면 error
# print(cabinet.get(5)) # () 경우 없으면 none
# print("hi")
...
#     time = randrange(1, 51)
#     if 5 <= time <= 15:
#         print("[0] " + str(i) + "번째 손님 (소요시간 : " + str(time) + "분)")
#         cnt += 1
#     else:
...
#         return balance-money
#     else:
#         print("출금이 완료되지 않았씁니다. 잔액은 {0} 원입니다.".format(balance))
#         return balance
